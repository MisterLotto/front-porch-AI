...
1. Download the `.dmg` from the [Releases page](https://github.com/linux4life1/front-porch-AI/releases).
2. Open it and drag **Front Porch AI** into your **Applications** folder.

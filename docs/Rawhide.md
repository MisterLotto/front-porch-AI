...
- 📅 **Seasons can start on any day** — tap the date on a season card for the same calendar Story begins uses (not a month dropdown). Same start twice, or a missing season, blocks save. Leave the dates alone and Earth months stay.

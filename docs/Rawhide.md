...
- 🎚️ **Thinking strength is visible** — Low / Medium / High chips in Settings (and web) show how hard the model should think, and when the current model only accepts a subset you see the map (e.g. Medium → High) instead of a silent failure.

...
//
// Season start is a month+day on the Earth calendar (leap years
// included). The stacked Jan/Feb dropdowns overflowed the climate
// dialog; this pins the existing showDatePicker instead.
